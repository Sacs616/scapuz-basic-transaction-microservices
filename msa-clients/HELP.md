...
* The original package name 'com.scapuz.msa-clients' is invalid and this project uses 'com.scapuz.msa_clients' instead.
...
```
$ docker run --rm -p 8080:8080 msa-clients:0.0.1-SNAPSHOT
```
